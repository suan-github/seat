...
<div class="seat">
    <table style="table-layout: fixed;">
        ...
        <tr>
            ...
            <td class="none-rl" colspan="4"></td>
            <td class="none-rlb" style="border-top-color: #5faae0;"></td>
            <td class="none-rl" style="border-top-color: #5faae0;"></td>
            <td class="none-rl" colspan="3"></td>
            <td class="none-rlb"></td>
            <td class="none-rl" colspan="4"></td>
            <td class="none-rlb"></td>
            <td class="none-rl"></td>
            <td class="none-rl" colspan="3" style="border-top-color: #5faae0;"></td>
