...
<button type="button" class="button" onclick="location.href='NewMember.php'">New Member</button>
...
<div class="seat">
    <table style="table-layout: fixed;">
        ...
        <tr>
            ...
            <td class="FW8-Cb" colspan="2">組長<br>Shaq</td>
            <td class="tg-0" colspan="2">Eddie</td>
            <td class="tg-0" colspan="2">Roy<br>Jasper</td>
            <td class="tg-0" colspan="2">Owen<br>Tom</td>
            <td class="BC-BW" colspan="2" style="border-top:none;">iCare</td>
            <td class="none-rb"></td>
            <td class="none-rlb"></td>
            <td class="none-tl" colspan="3"></td>
        </tr>
        <tr>
            <!--4-->
            <td class="none-rb"></td>
        ...
        <tr>
            ...
            <td class="none"></td>
            <td class="FW8-Cb" colspan="2" rowspan="2"><?PHP echo "$Android<br>組長<br>Hemly" ?></td>
            <td class="tg-0" colspan="2" rowspan="2"><?PHP echo "$Infra"; ?></td>
            <td class="none"></td>
            <td class="tg-0" colspan="2" rowspan="2"><?PHP echo "$Infra"; ?></td>
            <td class="tg-0" colspan="2" rowspan="2"><?PHP echo "$B"; ?></td>
            <td class="none"></td>
        ...
        <tr>
            <!--7-->
            <td class="none-trb"></td>
            <td class="FW8-Cb" colspan="2" rowspan="2"><?PHP echo "$PHP 副理<br>Kay"; ?></td>
            ...
            <td class="FW8-Cb" colspan="2" rowspan="2">運維副理<br>Jack</td>
            <td class="none"></td>
        ...
        <tr>
            <!--11-->
            <td class="none-trb"></td>
            <td class="FW8-Cb" colspan="2" rowspan="2">技術總監<br>Riven</td>
            ...
            <td class="FW8-Cb" colspan="2" rowspan="2">APP副理<br>Rico</td>
            <td class="none"></td>
            <td class="tg-0" colspan="2" rowspan="2"></td>
            <td class="tg-0" colspan="2" rowspan="2"></td>
            <td class="none"></td>
        ...
        <tr>
            <!--13-->
            <td class="FW8-Cb" colspan="6" rowspan="4">總經理室<br><br>總經理<br>Luke</td>
            <td class="none-rb"></td>
            <td class="none-rl" colspan="6">管理部</td>
            <td class="none-rlb"></td>
            <td class="none-l" colspan="2" rowspan="2"></td>
        ...
        <tr>
            ...
            <td class="FW8-Cb" colspan="2" rowspan="2">經理<br>Kelly</td>
